...
const main = require("./main-BeBzN5mE.js");
const node_url = require("node:url");
const require$$1 = require("node:net");
...
function requirePonyfill_es2018() {
  ...
  (function(module2, exports2) {
    (function(global, factory) {
      factory(exports2);
    })(ponyfill_es2018, function(exports3) {
      function noop() {
        return void 0;
      }
...
class Body {
  ...
  async formData() {
    ...
    const { toFormData } = await Promise.resolve().then(() => require("./multipart-parser-C5CIpGMe.js"));
...
const extractContentType = (body, request) => {
  ...
  if (node_buffer.Buffer.isBuffer(body) || util.types.isAnyArrayBuffer(body) || ArrayBuffer.isView(body)) {
    return null;
  }
...
function isOriginPotentiallyTrustworthy(url) {
  ...
  const hostIPVersion = require$$1.isIP(hostIp);
